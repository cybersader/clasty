...
- **Questions and ideas**: [Open a discussion](https://github.com/cybersader/obsidian-in-enterprise/discussions) on GitHub
- **Architecture feedback**: Review the [Architecture Components](/obsidian-in-enterprise/knowledge-base/03-reference/architecture-components/) page and share your thoughts
